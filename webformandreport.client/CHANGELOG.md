...
- Create Angular project with ng: `ng new webformandreport.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`webformandreport.client.esproj`).
